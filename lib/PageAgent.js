...
PageAgent.prototype = {
  ...
  _getResourceTreeForAppScript: function(mainAppScript, done) {
    console.log('mainAppScript %s', mainAppScript);
    async.waterfall(
      [
        this._scriptStorage.findAllApplicationScripts.bind(this._scriptStorage, mainAppScript),
