...
Session.prototype.setScriptSource = function (sourceID, newContent, seq) {
...
Session.prototype.stepOut = function () {
	this.client.continue('out', 1, nop)
	this.browser.sendEvent('Debugger.resumed')
}

Session.prototype.stepInto = function () {
	this.client.continue('in', 1, nop)
	this.browser.sendEvent('Debugger.resumed')
}

Session.prototype.stepOver = function () {
	this.client.continue('next', 1, nop)
	this.browser.sendEvent('Debugger.resumed')
}

Session.prototype.resume = function () {
	this.client.continue(null, null, nop)
	this.browser.sendEvent('Debugger.resumed')
}
...
Session.prototype.dispatchOnInjectedScript = nop

Session.prototype.evaluateOnCallFrame = nop
