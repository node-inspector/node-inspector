...
var RuntimeAgent = require('./Agents/RuntimeAgent.js').RuntimeAgent,
  PageAgent = require('./Agents/PageAgent.js').PageAgent,
  NetworkAgent = require('./Agents/NetworkAgent.js').NetworkAgent,
  DebuggerAgent = require('./Agents/DebuggerAgent.js').DebuggerAgent,
  ProfilerAgent = require('./Agents/ProfilerAgent.js').ProfilerAgent,
  HeapProfilerAgent = require('./Agents/HeapProfilerAgent.js').HeapProfilerAgent,
  ConsoleAgent = require('./Agents/ConsoleAgent.js').ConsoleAgent;
