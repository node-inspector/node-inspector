...
BreakEventHandler.prototype._onBreak = function(obj) {
  return co(function * () {
    ...
    error => this._frontendClient.sendLogToConsole('error', err));
};
...
BreakEventHandler.prototype._resolveScriptSource = function(obj, cb) {
  return new Promise((resolve, reject) => {
    ...
    this._scriptManager.resolveScriptById(obj.script.id, done);
  });
};
...
BreakEventHandler.prototype._handleContinueToLocation = function(obj) {
  ...
  return this._debuggerClient.request('clearbreakpoint', {
...
BreakEventHandler.prototype.sendBacktraceToFrontend = function(obj) {
  return co(function * () {
    ...
    this._frontendClient.emitEvent('Debugger.paused', {
      ...
      data: exception ? convert.v8RefToInspectorObject(exception) : undefined,
