...
BreakEventHandler.prototype._onBreak = function(obj) {
  return co(function * () {
    ...
    if (yield this._skipHidden(obj)) return;
...
BreakEventHandler.prototype._handleSkipAllPauses = function(obj) {
  return co(function * () {
    if (this._skipAllPauses)
      yield this._debuggerClient.request('continue');
    return this._skipAllPauses;
  }.bind(this));
};

BreakEventHandler.prototype._skipHidden = function(obj, script) {
  return co(function * () {
    var ignore = false;
    ...
    if (!this._scriptManager.get(obj.script.id))
      ignore = true;
    ...
    if (ignore)
      yield this._debuggerClient.request('continue', { stepaction: 'out' });
