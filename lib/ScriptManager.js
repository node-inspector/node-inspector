...
ScriptManager.prototype.startDirectory = function() {
  return co(function * () {
...
ScriptManager.prototype.findAllApplicationScripts = function() {
  return co(function * () {
    var startDirectory = yield this.startDirectory();
...
ScriptManager.prototype.load = function(path) {
  return co(function * () {
    ...
    var scriptId = this.findScriptIdByPath(scriptName);
    ...
    if (scriptId != null)
      return yield this.getScriptSourceById(scriptId);
