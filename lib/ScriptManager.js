...
ScriptManager.prototype = Object.create(events.EventEmitter.prototype, {
  ...
  _isHidden: {
    value: function(scriptName) {
      return this._hiddenScripts.some(function fnHiddenScriptMatchesName(r) {
        return r.test(scriptName);
      });
    }
  },
  ...
  addScript: {
    value: function(v8data) {
      ...
      var hidden = this._isHidden(localPath);

      if (hidden || this._isNodeInternal(localPath)) {
        this._doAddScript(v8data, hidden);
      } else {
        this._getSourceMapUrl(
          ...
          function onGetSourceMapUrlReturn(err, sourceMapUrl) {
            ...
            this._doAddScript(v8data, hidden, sourceMapUrl);
          }.bind(this)
        );
      }
    }
  ...
  _doAddScript: {
    value: function(v8data, hidden, sourceMapUrl) {
