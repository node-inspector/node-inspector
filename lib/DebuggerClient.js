 ...
 */
function DebuggerClient(config, session) {
...
DebuggerClient.prototype.break = function() {
  if (this[BREAK]) return this[BREAK];

  return this._break = new Promise((resolve, reject) => {
    this.once('break', clear(this, BREAK, resolve));
    this.once('error', clear(this, BREAK, reject));
  });
};
...
DebuggerClient.prototype.exception = function() {
  ...
  return this[EXCEPTION] = new Promise((resolve, reject) => {
    this.once('exception', clear(this, EXCEPTION, resolve));
    this.once('error', clear(this, EXCEPTION, reject));
  });
};

function clear(context, symbol, end) {
 ...
 * @param {!Object} params
 */
DebuggerClient.prototype.request = function(command, params) {
  return co(function * () {
    ...
    var response = yield this._connection.request(command, { arguments: params });
    if (response.refs)
