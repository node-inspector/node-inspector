...
var definitions = {
  ...
  'no-preload': {
    desc: '--no-preload         |             | Disables preloading *.js to speed up\n' +
          '                     |             |    startup',
    convert: conversions.stringToBoolean,
    defaultValue: false
  },
  'hidden': {
    desc: '--hidden             |     []      | Array of files to hide from the UI\n' +
          '                     |             |   (breakpoints in these files\n' +
          '                     |             |   will be ignored)',
    convert: conversions.stringToArray,
    defaultValue: []
  },
  'stack-trace-limit': {
    desc: '--stack-trace-limit  |     50      | Number of stack frames to show on a\n' +
          '                     |             |    breakpoint',
    convert: conversions.stringToInt,
    defaultValue: 50
  },
  'max-string-length': {
    desc: '--max-string-length  |     -1      | If string length exceed configured maximum,' +
