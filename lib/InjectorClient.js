...
InjectorClient.prototype._inject = function(TARGET_FRAME) {
  ...
  var options = {
    ...
    'DebuggerScript': require.resolve('./InjectedScript/DebuggerScript.js'),
    'InjectedScriptHost': require.resolve('./InjectedScript/InjectedScriptHostImplementation.js'),
    'InjectedScript': require.resolve('./InjectedScript/InjectedScriptSource.js')
  };
